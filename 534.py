...
lst=["right", "right", "right", "right", "right", "right", "right", "right"]
if lst.count('left') > lst.count('right'):
    print((lst.count('left') - lst.count('right'))//4)
else:
    print((lst.count('right') - lst.count('left')) // 4)